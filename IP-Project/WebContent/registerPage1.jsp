    					...
    					<div class="progress-bar" style="width: 0%"></div>
  						...
  						<button type="button" class="position-absolute top-0 start-100 translate-middle btn btn-sm btn-secondary rounded-pill" style="width: 2rem; height:2rem;">2</button>
							...
							<div class="text-center">
							    <p class="mt-3 text-secondary">Already have an account? <a href="loginPage.jsp">Sign In</a></p>
							    <p><a href="validationInput.jsp" class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Validation User Account Input Example</a></p>
							    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
							        <a class="btn btn-danger btn-lg me-md-6" type="submit">Sign Up</a>
							    </div>
							</div>
