...
<html>
<head>
    <title>Choose Enter Type Page</title>
    <meta charset="UTF-8">
...
<body>
	<div class="navbar">
        ...
        <div class="grid-item"> <a href="enterData.jsp"><img src="images/water.png" alt="water"></a></div>
        <div class="grid-item">Upload your Water/Electriclty/Recycle Bill in(PDF/JPEG/PDF)</div>
        
        
        <div class="grid-item"><a href="enterData.jsp"><img src="images/electrcity.png" alt="Electricity"></a></div>
        ...
        <div class="grid-item"><a href="enterWaterData.jsp"><img src="images/recycle.png" alt="Recycle"></a></div>
