...
<html>
<head>
    <title>Enter Water Data Page</title>
    <meta charset="UTF-8">
        ...
        <a href="landingPage.jsp">LOGOUT</a>
			...
			<div class="spacing"></div>
				<div class="fixed-size-div">
 	 				<div class="grid-item1"><p class="fs-1 text-success"><br>Water<br>Consumption<br>Calculation</p></div>
  					...
  					<form>
  										<label for="waterData" class="form-label">Enter Your <br>Water Consumption (m³):</label>
  												<textarea class="form-control" id="waterData" name="waterData"  required></textarea><br>
  													...
  													<a href="enterElectricityData.jsp"><input type="button" class="btn btn-danger" value="next"></a>
  					</form>
  					</div>
  					<div class="grid-item6"> 
  							<p class="text-center text-danger  ">{Water Consumption}<br> m3  x 0.419 kgCO2 /m3= {Carbon Footprint} kgCO2<br></p>
  					</div>
				</div>
